...
<?php
$page_title = 'Политика конфиденци<wbr/>ально<wbr/>сти'; 
$header_style = 'header-in-pages';
include_once('header-page.php') ?>

<section class="politics__inform inform">
  <div class="inform__container">
    <article class="inform__article flex">
      <p class="inform__article-text article-text-1">
      ...
      <p class="inform__article-text article-text-2">
      ...
      <p class="inform__article-text article-text-3">
      ...
      <p class="inform__article-text article-text-4">
      ...
      <p class="inform__article-text article-text-5">
      ...
      <p class="inform__article-text article-text-6">
...
<?php include_once('footer-politics.php') ?>